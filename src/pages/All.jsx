const All = ({text,setText,todos,saveTodo,editingId}) => {
	return (
		<div>
			...
			<div class="mb-2">
				...
				<input
					...
					text-[13px]"
				/>
				<button className="absolute right-2 top-4 -translate-y-npmr1/2 text-white
				  bg-[#f0ad83] rounded-lg px-2 py-1 hover:bg-[#F59E0B] cursor-pointer" onClick={saveTodo}>
